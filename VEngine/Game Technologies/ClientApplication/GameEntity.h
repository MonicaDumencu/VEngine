...
public:
	...
	GameEntity(bool val = false);
	GameEntity(SceneNode* s, PhysicsNode* p, bool val = false);
	...
	// ---------------- Added by Monica --------------------------- ///
	// needed for terrain generation 
	void			SetRenderNode(SceneNode* sNode) { renderNode = sNode; }
	void			SetPhysicsNode(PhysicsNode* pNode) { physicsNode = pNode; }

	int				getId() const { return id; }

	void			SetConnectToPhysicsSystem(bool b) { connectToPhysicsSystem = b; }
	bool			GetConnectToPhysicsSystem() const { return connectToPhysicsSystem; }
	// ------------------------------------------------------------- //
